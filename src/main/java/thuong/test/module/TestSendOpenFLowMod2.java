...
public class TestSendOpenFLowMod2 implements IFloodlightModule,
		IOFMessageListener {
...
//			if (sw.getId() == DatapathId.of("00:00:00:00:00:00:00:01")) {
			if (sw.getId().getLong() == 1) {
				...
				TTSendPackageSwitch.writePacketOutForPacketIn(sw, packetin, OFPort.of(2));
			}
...
//			if (sw.getId() == DatapathId.of("00:00:00:00:00:00:00:02")) {
		...
		if (packetin.getInPort() == OFPort.of(2)) {
			log.info("port 2");
...
//			if (sw.getId() == DatapathId.of("00:00:00:00:00:00:00:01")) {
			if (sw.getId().getLong() == 1) {
				...
				TTSendPackageSwitch.writePacketOutForPacketIn(sw, packetin, OFPort.of(1));
